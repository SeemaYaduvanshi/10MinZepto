...
def aboutaman(request):
    return render(request,'user/aman.html')
def aboutpawan(request):
    return render(request,'user/pawan.html')
def aboutseema(request):
    return render(request,'user/seema.html')
